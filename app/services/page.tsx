...
export const metadata: Metadata = {
  title: "Services | Northbridge Digital",
  description:
    "Northbridge Digital helps businesses replace operational complexity with intelligent systems—customer acquisition, operations, visibility, and custom software.",
};
  ...
  return (
    <div className="nb-page">
      <section className="max-w-3xl">
        ...
        <h1 className="mt-3 nb-h1">Services</h1>
        <p className="mt-6 nb-lead text-balance">
          Northbridge Digital helps businesses replace operational complexity with intelligent
          systems.
        </p>
        <p className="mt-4 nb-body max-w-2xl">
          Northbridge Digital is the client services division of Northbridge Venture Group. We design
          customer acquisition systems, operational automation, business intelligence, and custom
          platforms for organizations ready to modernize how they grow and operate.
        </p>
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <Link href="/digital" className="btn-secondary">
            Explore Northbridge Digital
          </Link>
        </div>
      </section>

      <section className="mt-24">
        <p className="nb-eyebrow">Solution categories</p>
