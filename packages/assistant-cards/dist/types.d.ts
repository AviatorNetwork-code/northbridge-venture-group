...
export declare const ASSISTANT_RICH_CARD_SCHEMA_VERSION: "1.0";
export type AssistantRichCardSchemaVersion = typeof ASSISTANT_RICH_CARD_SCHEMA_VERSION;
/** Recognized rich card variants for Assistant Shell rendering. */
export type AssistantCardType = "explanation" | "recommendation" | "confirmation_request" | "tool_result" | "warning" | "error" | "next_steps";
...
export type AssistantCardMetadata = Readonly<Record<string, string | number | boolean | null>>;
/**
...
export declare const ASSISTANT_CARD_TYPES: readonly AssistantCardType[];
export declare const ASSISTANT_CARD_SEVERITIES: readonly AssistantCardSeverity[];
/** Cards that require a severity field. */
export declare const SEVERITY_REQUIRED_CARD_TYPES: readonly AssistantCardType[];
/** Cards that require at least one action. */
export declare const ACTIONS_REQUIRED_CARD_TYPES: readonly AssistantCardType[];
