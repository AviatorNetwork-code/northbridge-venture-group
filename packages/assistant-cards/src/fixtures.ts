...
export const explanationCardFixture: AssistantRichCard = {
  schema_version: "1.0",
...
export const recommendationCardFixture: AssistantRichCard = {
  schema_version: "1.0",
...
export const confirmationRequestCardFixture: AssistantRichCard = {
  schema_version: "1.0",
  id: "card_confirm_001",
...
export const toolResultCardFixture: AssistantRichCard = {
  schema_version: "1.0",
...
export const warningCardFixture: AssistantRichCard = {
  schema_version: "1.0",
  id: "card_warning_001",
  type: "warning",
...
export const errorCardFixture: AssistantRichCard = {
  schema_version: "1.0",
  id: "card_error_001",
  type: "error",
...
export const nextStepsCardFixture: AssistantRichCard = {
  schema_version: "1.0",
