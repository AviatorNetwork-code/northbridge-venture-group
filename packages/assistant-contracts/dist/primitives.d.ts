...
export type IntentType = "inform" | "explain" | "draft" | "recommend" | "tool_request" | "clarify" | "unsupported";
/** Confirmation gate required before side effects or NOP handoff. */
export type ConfirmationRequirement = "none" | "user_confirm" | "supervisor_approve" | "neo_gate";
/** Rich card and tool result lifecycle status. */
export type ResponseStatus = "success" | "warning" | "error" | "pending" | "unsupported" | "missing_data";
/** Confirmation Framework stage. */
export type ConfirmationStage = "draft" | "review" | "confirm" | "execute" | "report" | "cancelled" | "timed_out";
