...
export {
  ...
  researchSourceReferenceSchema,
} from "./metadata.js";

export type {
  ResearchDocument,
  ResearchDocumentFrontmatter,
  ResearchDocumentSection,
} from "./document-schema.js";
export {
  researchDocumentFrontmatterSchema,
