import { z } from "zod";
import { metricIdSchema, organizationIdSchema, teamIdSchema, teamLeadIdSchema, teamReportIdSchema, } from "./primitives.js";
...
export const teamReportSchema = z
    ...
    .strict();
export function parseOperationalMetric(input) {
    return operationalMetricSchema.parse(input);
}
export function parseTeamReport(input) {
    return teamReportSchema.parse(input);
}
export function safeParseTeamReport(input) {
