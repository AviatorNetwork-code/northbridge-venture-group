...
export const NDP_LAUNCH_EMPLOYEE_MANIFESTS: DigitalEmployeeManifest[] = [
  ...
  manifest({
    ...
    connectorCapabilities: ["finance.analyze", "financial.report", "accounting.report.read"],
    knowledgePackIds: [
      ...PRO_COMMUNICATION,
      "knowledge-pack-business-writing",
      "knowledge-pack-financial-fundamentals",
      "knowledge-pack-cash-flow-basics",
      "knowledge-pack-expense-awareness",
      ...ORG_STANDARDS,
    ],
  ...
  manifest({
    ...
    knowledgePackIds: [
      ...PRO_COMMUNICATION,
      "knowledge-pack-financial-fundamentals",
      "knowledge-pack-billing-fundamentals",
      ...ORG_STANDARDS,
    ],
  ...
  manifest({
    ...
    knowledgePackIds: [
      ...PRO_COMMUNICATION,
      "knowledge-pack-financial-fundamentals",
      "knowledge-pack-accounts-receivable-fundamentals",
      "knowledge-pack-payment-followup-strategy",
      ...ORG_STANDARDS,
    ],
    permissions: createSpecialistPermissions(["finance:write"]),
  }),
  manifest({
    ...
    connectorCapabilities: ["financial.report", "accounting.report.read", "finance.analyze"],
    knowledgePackIds: [
      ...PRO_COMMUNICATION,
      "knowledge-pack-financial-fundamentals",
      "knowledge-pack-financial-reporting",
      ...ORG_STANDARDS,
    ],
